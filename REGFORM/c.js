...
function insertNewRecord(data) {
  ...
  cell6.innerHTML = data.Ema;
  cell7 = newRow.insertCell(6);
  cell7.innerHTML = data.Addr;
...
function onEdit(td) {
  ...
  document.getElementById("ROL").value = selectedRow.cells[1].innerHTML;
...
function updateRecord(formData) {
  ...
  selectedRow.cells[1].innerHTML = formData.ROL;
